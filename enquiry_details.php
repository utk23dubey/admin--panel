    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">Pending Enquires</h1>
                    ...
                    $i=1;
                    $sql = "SELECT * FROM enquiry where id NOT IN (SELECT enquiry_id FROM followup where status ='Confirm' OR status='Reject') ";
                    ...
                    if($result1 = mysqli_query($conn, $sql1)){
                        ...
                        $sql3= "SELECT name FROM myusers where id=". $row['assigned']. "";
